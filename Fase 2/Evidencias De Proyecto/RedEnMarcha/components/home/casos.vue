<template>
    <div class="w-full  h-5/6 border border-gray-300 flex flex-col align-top justify-start items-start mx-auto bg-white rounded-xl shadow-xl shadow-gray-300 p-4 overflow-hidden">
      <header>
