<template>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-red-500">
        <div class="bg-white p-8 rounded-lg shadow-2xl transform hover:scale-105 transition-all duration-300 max-w-md w-full">
...
const handleSubmit = () => {
    if (isFormValid.value) {
        console.log('Formulario enviado:', { email: email.value, password: password.value })
    router.push('/')
    }
}
